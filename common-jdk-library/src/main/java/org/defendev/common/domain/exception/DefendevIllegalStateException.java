...
/**
 * Generic application exception, caused by internal server error, which doesn't fall into any other
 * more specific category.
 *
 */
public class DefendevIllegalStateException extends RuntimeException implements IdentifiableException {

    private ErrorWrapperDto errorWrapperDto;

    private final String exceptionId;

    public DefendevIllegalStateException(ErrorDto errorDto) {
        this(errorDto, false);
    }

    public DefendevIllegalStateException(ErrorDto errorDto, boolean doGenerateExceptionId) {
    ...
    public DefendevIllegalStateException(ErrorWrapperDto errorWrapperDto) {
        this(errorWrapperDto, false);
    }

    public DefendevIllegalStateException(ErrorWrapperDto errorWrapperDto, boolean doGenerateExceptionId) {
